...
def train_end_to_end_model(
    ...
    if test_dl is not None:
        ...
        logging.info(f'test_c_acc: {eval_results["test_acc_c"]}%')
        logging.info(f'test_c_auc: {eval_results["test_auc_c"]}%')
        logging.info(f'test_c_f1: {eval_results["test_f1_c"]}%')
        logging.info(f'test_y_acc: {eval_results["test_acc_y"]}%')
        logging.info(f'test_y_auc: {eval_results["test_auc_y"]}%')
        logging.info(f'test_y_f1: {eval_results["test_f1_y"]}%')
