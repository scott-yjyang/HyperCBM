    ...
    def _forward(
        ...
        if latent is None:
            ...
            for i, context_gen in enumerate(self.concept_context_generators):
                ...
                context = context_gen(pre_c)  # [batch_size, resnet_out_features] -> [batch_size, 2 * emb_size] this is the concept embedding
            ...
            contexts = torch.cat(contexts, axis=1) # [batch_size, n_concepts, 2 * emb_size]
        ...
        ) # concept embedding: [batch_size, n_concepts, emb_size]
        ...
        c_pred_unlabeled = self.sigmoid(c_pred_unlabeled) # [batch_size, n_concepts]
